defmodule MathesisWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MathesisWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MathesisWeb.Gettext, "errors", msg, opts)
    end
  end
